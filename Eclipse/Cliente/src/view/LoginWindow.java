...
public class LoginWindow  extends JFrame{
	...
	/**
	 * Acciona el login una vegada introduida la informaci� requerida.
	 * @see JButton
	 */
	...
	/**
	 * Constructor de la ventana de inici de sessi� de usuari.
	 * @see JPanel
	 * @see JLabel
	 * @see TitledBorder
	 */
	...
	/**
	 * Controlador de input de informaci� d'usuari
	 * @param controller Action listener utilitzat per a controlar l'interacci� de l'usuari
	 * @see ActionListener
	 */
	...
	/**
	 * M�tode que retorna el nom d'susari entrat
	...
	/**
	 * M�tode que retorna la contrasenya d'usuari entrada
