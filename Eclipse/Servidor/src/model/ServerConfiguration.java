...
public class ServerConfiguration {
	/**
	 * Port de conexió a la base de dades.
	 * @see database.DDBBConnection
	 */
	private int portConexionBBDD;
	/**
	 * Direcció IP de la base de dades
	 * @see database.DDBBConnection
	 */
	...
	/**
	 * Port de comunicació amb el client
	 * @see network.Server
	 */
	private int portClientComunication;
	
	/**
	 * Construeix una configuració de servidor
	 * @param portConexionBBDD Port de conexió a la base de dades.
	 * @param iPBBDD Direcció IP de la base de dades
	 ...
	 * @param portClientComunication Port de comunicació amb el client
	 */
	...
	/**
	 * Constructor buit de una configuració buida de servidor.
	 */
	public ServerConfiguration(){
	}
	/**
	 * Getter del port de conexió a la base de dades
	...
	/**
	 * Setter del port de conexió amb la base de dades
	...
	/**
	 * Getter de la direcció IP del host de la base de dades
	...
	/**
	 * Setter de la direcció IP del host de la base de dades
	 * @param iPBBDD
	 */
	...
	/**
	 * Getter del port de comunicació amb el client
	 * @return Client port
	 */
	...
	/**
	 * Setter del port de comunicació amb el client
